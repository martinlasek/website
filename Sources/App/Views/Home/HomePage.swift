                ...
                .section(attributes: [.class("site-hero")],
                    .div(attributes: [.class("site-wrap site-hero-inner")],
                        ...
                        .div(attributes: [.class("site-actions")],
                            SiteComponents.button(SiteLink(title: "See my projects →", destination: "/projects")),
                ...
                .section(attributes: [.class("site-section")],
                    .div(attributes: [.class("site-wrap")],
                        .div(attributes: [.class("site-section-heading")],
                            .div(.p(attributes: [.class("site-eyebrow")], "Featured projects"), .h2("Projects I'm Building")),
                            SiteComponents.button(SiteLink(title: "View all projects →", destination: "/projects"))),
                        PublicSite.products)),
