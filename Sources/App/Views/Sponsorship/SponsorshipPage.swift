        ...
        PageBuilder.base(navLink: .sponsorship) {
            .div(attributes: [.class("c-card bg-body-tertiary")],
                ...
                .ul(
                    ...
                    .li("A thank you ", .a(attributes: [.href("https://twitter.com/MartinLasek"), .class("ml-link")], "tweet from Martin"), " to his 3,000+ followers."),
                    .li("You are added to the list of sponsors with a backlink to your website."),
                    .li(.b("To top it off, the cost is just $250 per week for everything."))
                ),
