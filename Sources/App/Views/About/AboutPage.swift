            ...
            content: .div(attributes: [.class("site-wrap site-archive")],
                ...
                .div(attributes: [.class("site-about-layout")],
                    .div(attributes: [.class("site-prose")],
                        ...
                        .p("Have a question about a post or one of my apps? You can find me on X or GitHub."),
                        .div(attributes: [.class("site-actions")],
                            ...
                            SiteComponents.button(SiteLink(title: "GitHub ↗", destination: "https://github.com/martinlasek")))
                    ),
