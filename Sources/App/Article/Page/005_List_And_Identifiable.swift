...
extension Article {
    static let a_005_List_And_Identifiable = Article(
        ...
        category: "Swift",
        cover: ArticleCover(path: "/images/blog/list-and-identifiable-in-swiftui-2.png", alt: "", width: 1200, height: 630),
        hero: ArticleCover(path: "/images/blog/list-and-identifiable-in-swiftui-hero-v2.webp", alt: "", width: 1600, height: 700),
        contentList: [
